      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden pt-16">
        ...
        <div className="container relative z-10 px-4 py-24 md:px-6">
          <div className="mx-auto max-w-3xl text-center">
            <div>
              <Badge className="mb-4">Now Streaming</Badge>
              ...
              <p className="mb-8 mx-auto max-w-2xl text-lg text-muted-foreground md:text-xl">
                Creating original animations and stories that inspire, entertain, and connect with audiences worldwide.
              </p>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
          <div className="flex flex-col items-center">
            ...
            <div className="mt-2 h-10 w-6 rounded-full border border-muted p-1">
              <div className="h-2 w-full rounded-full bg-primary animate-pulse"></div>
            </div>
          </div>
        </div>
      </section>
