      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto space-y-6 text-base md:text-lg">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">External Links Disclaimer</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Media and Intellectual Property</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Automated Moderation Tools</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">No Professional Advice</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Accuracy of Information</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Changes to this Disclaimer</h2>
            <p className="mb-6">
