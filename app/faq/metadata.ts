...
export const metadata = getMetadata({
  ...
  description:
    "Find answers to common questions about Flavor Studios, animation, support, and our creative process. Get the info you need to enjoy our content and community.",
  path: "/faq",
  openGraph: {
    images: [
      {
