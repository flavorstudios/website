      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto space-y-6 text-base md:text-lg">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Use of the Site</h2>
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Intellectual Property Rights</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">User-Generated Content</h2>
            <ul className="list-disc pl-6 space-y-3 mb-6">
              <li>
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Third-Party Links</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Disclaimer</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Limitation of Liability</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Indemnification</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Termination</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Governing Law</h2>
            <p className="mb-6">
              These Terms shall be governed by and construed in accordance with the laws of India, without regard to
              conflict of law principles.
            </p>

            <h2 className="text-2xl md:text-3xl font-bold mt-10 mb-4 font-orbitron">Changes to Terms</h2>
            <p className="mb-6">
