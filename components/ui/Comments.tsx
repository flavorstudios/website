...
return ( <div className="w-full max-w-4xl mx-auto mt-12 mb-16"> <div className="flex items-center justify-between mb-6"> <h2 className="text-2xl font-bold font-orbitron gradient-text flex items-center"> <MessageSquare className="mr-2 h-5 w-5" />
Comments </h2>
