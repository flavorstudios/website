...
export const clientEnvSchema = z.object({
  ...
  NEXT_PUBLIC_ENABLE_LEGACY_ADMIN_LOGIN: optionalNonEmptyString,
...
const rawClientEnv = {
  ...
  NEXT_PUBLIC_ENABLE_LEGACY_ADMIN_LOGIN:
    process.env.NEXT_PUBLIC_ENABLE_LEGACY_ADMIN_LOGIN,
...
const defaults: ClientEnvShape = {
  ...
  NEXT_PUBLIC_ENABLE_LEGACY_ADMIN_LOGIN: undefined,
