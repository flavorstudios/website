...
// import { nanoid } from "nanoid" // Uncomment for nanoid IDs

const DATA_DIR = path.join(process.cwd(), "admin-data")

// ---- Interfaces ----
// Ideally, import these from /lib/data.ts for DRY type safety!
...
export const blogStore = {
  ...
  async create(post: Omit<BlogPost, "id" | "createdAt" | "updatedAt" | "views">): Promise<BlogPost> {
    ...
    const newPost: BlogPost = {
      ...post,
      // id: `post_${nanoid()}`, // Use nanoid for bulletproof ID
